...
Route::post('product/removeproductsale/{sale}/{product}/{quantity}', 'AddProductController@remove_product_sale')->name('addproduct.remove_product_sale');

Route::post('product/addproductloan/{loan}', 'AddProductController@loan')->name('addproductloan.loan');
Route::post('product/removeproductloan/{loan}/{product}/{quantity}', 'AddProductController@remove_product_loan')->name('addproduct.remove_product_loan');


Route::resource('loan', 'LoanController');
Route::post('loan/{loan}', 'LoanController@savechanges')->name('loan.savechanges');
